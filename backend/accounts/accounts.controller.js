...
function register(req, res, next) {
    ...
    accountService.register(req.body, req.get('origin'))
        .then(() => res.json({ message: messageProperties.RegistrationSuccess }))
        .catch(next);
}
...
function addphone(req, res, next) {
    ...
    accountService.addphone(req.body, req.params.Users_id)
        .then(() => res.json({ message: messageProperties.PhoneAddSuccess }))
        .catch(next);
}
...
function addemail(req, res, next) {
    ...
    accountService.addemail(req.body, req.params.Users_id)
        .then(() => res.json({ message: messageProperties.EmailAddSuccess }))
        .catch(next);
}
...
function addaddress(req, res, next) {
    ...
    accountService.addaddress(req.body, req.params.Users_id)
        .then(() => res.json({ message: messageProperties.AddressAddSuccess }))
        .catch(next);
}
...
function _delete(req, res, next) {
    ...
    accountService.delete(req.params.id)
        .then(() => res.json({ message: messageProperties.UserDeleteSuccesss }))
        .catch(next);
}
